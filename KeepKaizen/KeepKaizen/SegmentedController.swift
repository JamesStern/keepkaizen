...
@IBDesignable class ADVSegmentedControl: UIControl {
    ...
    var items: [String] = ["INCREASE", "DECREASE"] {
        didSet {
            setupLabels()
        }
    }
    ...
    @IBInspectable var unselectedLabelColor : UIColor = UIColor.red {
        didSet {
            setSelectedColors()
        }
    }
    
    @IBInspectable var thumbColor : UIColor = UIColor(red: 69/255, green: 202/255, blue: 230/255, alpha: 1) {
        didSet {
            setSelectedColors()
        }
    }
    ...
    func setupView(){
        ...
        layer.borderColor = UIColor(red: 69/255, green: 202/255, blue: 230/255, alpha: 1).cgColor
        layer.borderWidth = 1
